document.addEventListener('DOMContentLoaded', function () {
    ...
    if (isValid) {
      ...
      if (firstError) {
        firstError.closest('.form-group, .field-wrapper, div') &&
          firstError.closest('.form-group, .field-wrapper, div').querySelector('input, textarea, select') &&
          firstError.closest('.form-group, .field-wrapper, div').querySelector('input, textarea, select').focus();
      }
    }
  });
  ...
  function handleFormSuccess(form) {
    ...
    message.textContent = 'Your message has been sent successfully. We will be in touch shortly.';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '071879eb-86e6-4a92-bf34-0b6b72079a85',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '071879eb-86e6-4a92-bf34-0b6b72079a85';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '071879eb-86e6-4a92-bf34-0b6b72079a85';
